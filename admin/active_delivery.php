...
<span class="create_item"><a href="delivery_create.php">Create Deliverer</a></span>
<span class="create_item"><a href="suspended_delivery.php">Suspended Deliverer</a></span>

<h2 style="float: right;" id="h2">Total Active Deliverers:
<?php
$query1 = "SELECT * FROM customer WHERE flag=4 AND active=1";
...
<h1 id="h1">Active Deliverer Information</h1>

<?php

$query = "select username,email,phone,fname,lname from customer where flag=4 and active=1;";
$query_run = mysqli_query($con,$query);
...
<table>
    ...
    <tr>
        ...
        <td colspan="2">
            <form action = "active_delivery.php" method = "post">
    ...
    function moonIcon() {
     ...
     function alterMenu(){
      ...
      xhttp.onload = function() {
        ...
        var url = "search/search5.php?searchQuery="+document.getElementById("search").value;  
        else
        var url = "search/search5.php";  
