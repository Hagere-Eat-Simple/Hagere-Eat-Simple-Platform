...
if(isset($_POST['del']))
{
  ...
  $sql = "UPDATE resturant set state = 0 where username = '$value'";
...
if(isset($_POST['open']))
{
  ...
  $sql = "UPDATE resturant set state = 1 where username = '$value'";
if (mysqli_query($conn, $sql)) {
  echo "Record deleted successfully";
} else {
  echo "Error deleting record: " . mysqli_error($conn);
...
<div class="container px-4 py-5" id="featured-3">
    <h2 class="pb-2 border-bottom">Are you sure you want to close this resturant</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        ...
        <form name="delete" method="POST" action = "<?php echo $_SERVER["PHP_SELF"];?>">
          ...
          <button class="w-100 btn btn-danger btn-lg m-2" name="del">Close</button>
        </form>
        <form name="delete" method="POST" action = "<?php echo $_SERVER["PHP_SELF"];?>">
         
          <button class="w-100 btn btn-success btn-lg m-2" name="open">Open</button>
        </form>

        <form name="back" method="POST" action="<?php echo $_SERVER["PHP_SELF"];?>" >
         
         <button class="w-100 btn btn-primary btn-lg m-2"  name="bb">Go back</button>
       </form>
      </div>
